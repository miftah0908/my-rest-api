    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api Miftah - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6285171226069">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>Miftah</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"Miftah GanzZ" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api Miftah`,
        html: inboxGmail,
      };
